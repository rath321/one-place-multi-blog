...
The example application is a social blogging site (i.e. a Medium.com clone) called "OPMB". It uses a custom API for all requests, including authentication. You can view a live demo over at https://angular.realworld.io
